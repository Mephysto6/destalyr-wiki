    ...
    },
    {
      ...
      "skill_list": {
        ...
        "Duéliste": {
          ...
          "details_text": "(1) Si seulement une des deux mains porte une arme, alors gagne un +1 au toucher. \
    ...
    },
    {
      ...
      "skill_list": {
        ...
        "Charge": {
          ...
          "details_text": "(1) Débloque l'action charger. Se déplace jusqu'à 3 cases avant d'attaquer. Coûte même PA que l'attaque seule. \
    ...
    },
    {
      ...
      "skill_list": {
        ...
        "Fort": {
          ...
          "details_text": "Gagne +1 de dégâts sur attaques de mêlées. Si touche mais dégâts = 0, alors dégâts = 1. Si l'attaque fait 5 dégâts ou plus, alors continuation.",
          "category": "ATK",
          "header": "false",
          "type": "Passif",
          "levels": "1",
